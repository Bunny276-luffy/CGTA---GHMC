  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-6 px-4">
      ...
      <div className="text-center md:text-left space-y-3 max-w-2xl mb-8">
        <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-950/20 px-3.5 py-1 text-xs font-mono font-bold text-cyan-400">
          <Sparkles className="h-3.5 w-3.5" />
          Interactive Role Consoles
        </div>
